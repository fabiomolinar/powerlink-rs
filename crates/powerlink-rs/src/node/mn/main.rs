...
use crate::frame::{deserialize_frame, PowerlinkFrame, ServiceId}; // Import SocFrame and SocFlags
use crate::frame::control::{SocFlags, SocFrame}; // Corrected import
use crate::nmt::mn_state_machine::MnNmtStateMachine;
use crate::nmt::state_machine::NmtStateMachine;
use crate::nmt::states::NmtState;
use crate::node::{
    CoreNodeContext, Node, NodeAction, NodeContext, PdoHandler, serialize_frame_action,
};
use crate::od::constants;
use crate::od::{Object, ObjectDictionary, ObjectValue, PdoMapping}; // Corrected import
...
impl<'s> ManagingNode<'s> {
    ...
    pub fn new(
        ...
        let node_id = nmt_state_machine.node_id();
