...
pub struct GeneralFeatures {
    ...
    #[serde(
        rename = "@DLLErrBadPhysMode",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub dll_err_bad_phys_mode: Option<bool>,
    #[serde(
        rename = "@DLLErrMacBuffer",
        default,
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct MnFeatures {
    ...
    #[serde(
        rename = "@DLLMNFeatureMultiplex",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub dll_mn_feature_multiplex: Option<bool>,
    #[serde(
        rename = "@DLLMNPResChaining",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub dll_mn_pres_chaining: Option<bool>,
    #[serde(
        rename = "@DLLMNFeaturePResTx",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "@NMTMNRedundancy",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub nmt_mn_redundancy: Option<bool>,
    #[serde(
        rename = "@DLLMNRingRedundancy",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub dll_mn_ring_redundancy: Option<bool>,
    #[serde(
        rename = "@NMTMNMaxAsynchronousSlots",
        default,
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct CnFeatures {
    ...
    #[serde(
        rename = "@DLLCNPResChaining",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub dll_cn_pres_chaining: Option<bool>,
    #[serde(
        rename = "@NMTCNPreOp2ToReady2Op",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "@DLLCNLossOfSoCToleranceMax",
        default,
        skip_serializing_if = "Option::is_none"
    )]
