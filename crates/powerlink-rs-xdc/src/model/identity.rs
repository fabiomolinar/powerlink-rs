...
pub struct DeviceIdentity {
    ...
    #[serde(rename = "vendorText", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "productText", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "specificationRevision", default, skip_serializing_if = "Option::is_none")]
